...
////// ---  displayAllCards(selections) ----------
// - Added date: 2025/10/13 1:32am
// - Display all cards available in the deck for reference purpose
// - This ignores options except for invert color and invert hue

function displayAllCards(selections) {
  ...
  displayCards(PictureCards.getAllCards(), selections);
}
